...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" rev="stylesheet" href="./img_login/Member_Web_Login_Form.css" type="text/css">
    ...
    <div class="login-wrap">
        <div class="iframe-layer-mask not-in-layer" id="iframeLoginMask">
            ...
            <div class="iframe-login-wrap" id="iframeLoginWrap">
                ...
                <iframe class="iframe-login-ifm" id="iframeLoginIfm" src="./img_login/iframeform.html" frameborder="0" scrolling="no"></iframe>
            </div>
        </div>
    </div>
</div>
...
<!-- 侧边栏 end -->
	<script src="./img_login/push.js"></script>
	<script type="text/javascript" async="" src="./img_login/s.js"></script>
	<script type="text/javascript" crossorigin="" src="./img_login/jquery-underscore.min.js"></script>
	<script type="text/javascript" crossorigin="" src="./img_login/bbv10.js"></script>
	<script type="text/javascript" crossorigin="" src="./img_login/Member_Web_Login_Form.js"></script>
	<script type="text/javascript" async="" src="./img_login/referrer_anjuke_pc.js"></script>
</body>
</html>